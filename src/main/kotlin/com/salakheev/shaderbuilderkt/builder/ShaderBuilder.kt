...
import com.salakheev.shaderbuilderkt.builder.delegates.AttributeDelegate
import com.salakheev.shaderbuilderkt.builder.delegates.BuiltinVarDelegate
import com.salakheev.shaderbuilderkt.builder.delegates.ConstructorDelegate
import com.salakheev.shaderbuilderkt.builder.delegates.UniformArrayDelegate
import com.salakheev.shaderbuilderkt.builder.delegates.UniformDelegate
import com.salakheev.shaderbuilderkt.builder.delegates.VaryingDelegate
...
abstract class ShaderBuilder : ShaderSourceProvider {
	...
	override fun getSource(): String {
		...
		uniforms.forEach {
			sb.appendln("uniform $it;")
		}
		attributes.forEach {
			sb.appendln("attribute $it;")
		}
		varyings.forEach {
			sb.appendln("\nvarying $it;")
		}

		sb.appendln("void main(void) {")
	...
	protected fun <T : Variable> uniformArray(size: Int, init: (builder: ShaderBuilder) -> T) = UniformArrayDelegate(size, init)
	...
	protected fun clamp(v: GLFloat, min: GLFloat, max: GLFloat) = GLFloat(this, "clamp(${v.value}, ${min.value}, ${max.value})")
	...
	protected fun clamp(v: Vec2, min: GLFloat, max: GLFloat) = Vec2(this, "clamp(${v.value}, ${min.value}, ${max.value})")
	protected fun clamp(v: Vec3, min: GLFloat, max: GLFloat) = Vec3(this, "clamp(${v.value}, ${min.value}, ${max.value})")
	protected fun clamp(v: Vec4, min: GLFloat, max: GLFloat) = Vec4(this, "clamp(${v.value}, ${min.value}, ${max.value})")

	protected fun clamp(v: GLFloat, min: Float, max: Float) = GLFloat(this, "clamp(${v.value}, ${min.str()}, ${max.str()})")
	protected fun clamp(v: GLFloat, min: GLFloat, max: Float) = GLFloat(this, "clamp(${v.value}, ${min.value}, ${max.str()})")
	...
	protected fun smoothstep(v: GLFloat, u: GLFloat, x: GLFloat) = GLFloat(this, "smoothstep(${v.value}, ${u.value}, ${x.value})")
	...
	protected fun refract(i: GenType, n: GenType, eta: GLFloat) = Vec3(this, "refract(${i.value}, ${n.value}, ${eta.value})")
	...
	protected fun vec3(x: GLFloat, y: GLFloat, z: GLFloat) = ConstructorDelegate(Vec3(this), ("vec3(${x.value}, ${y.value}, ${z.value})"))
	protected fun vec3(x: GLFloat, y: GLFloat, z: Float) = ConstructorDelegate(Vec3(this), ("vec3(${x.value}, ${y.value}, ${z.str()})"))
	protected fun vec3(x: GLFloat, y: Float, z: GLFloat) = ConstructorDelegate(Vec3(this), ("vec3(${x.value}, ${y.str()}, ${z.value})"))
	protected fun vec3(x: GLFloat, y: Float, z: Float) = ConstructorDelegate(Vec3(this), ("vec3(${x.value}, ${y.str()}, ${z.str()})"))
	protected fun vec3(x: Float, y: GLFloat, z: GLFloat) = ConstructorDelegate(Vec3(this), ("vec3(${x.str()}, ${y.value}, ${z.value})"))
	protected fun vec3(x: Float, y: GLFloat, z: Float) = ConstructorDelegate(Vec3(this), ("vec3(${x.str()}, ${y.value}, ${z.str()})"))
	protected fun vec3(x: Float, y: Float, z: GLFloat) = ConstructorDelegate(Vec3(this), ("vec3(${x.str()}, ${y.str()}, ${z.value})"))
	protected fun vec3(x: Float, y: Float, z: Float) = ConstructorDelegate(Vec3(this), ("vec3(${x.str()}, ${y.str()}, ${z.str()})"))
	...
	protected fun vec4(vec2: Vec2, z: Float, w: Float) = ConstructorDelegate(Vec4(this), ("vec4(${vec2.value}, ${z.str()}, ${w.str()})"))
	protected fun vec4(x: GLFloat, y: GLFloat, zw: Vec2) = ConstructorDelegate(Vec4(this), ("vec4(${x.value}, ${y.value}, ${zw.value})"))

	protected fun vec4(x: Float, y: Float, z: Float, w: Float) = ConstructorDelegate(Vec4(this), ("vec4(${x.str()}, ${y.str()}, ${z.str()}, ${w.str()})"))
	protected fun vec4(x: Float, y: Float, z: Float, w: GLFloat) = ConstructorDelegate(Vec4(this), ("vec4(${x.str()}, ${y.str()}, ${z.str()}, ${w.value})"))
	protected fun vec4(x: GLFloat, y: GLFloat, z: GLFloat, w: GLFloat) = ConstructorDelegate(Vec4(this), ("vec4(${x.value}, ${y.value}, ${z.value}, ${w.value})"))
	protected fun vec4(x: GLFloat, y: GLFloat, z: GLFloat, w: Float) = ConstructorDelegate(Vec4(this), ("vec4(${x.value}, ${y.value}, ${z.value}, ${w.str()})"))
	protected fun vec4(x: GLFloat, y: GLFloat, z: Float, w: Float) = ConstructorDelegate(Vec4(this), ("vec4(${x.value}, ${y.value}, ${z.str()}, ${w.str()})"))
